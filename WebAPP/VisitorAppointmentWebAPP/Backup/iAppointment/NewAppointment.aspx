    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" ViewStateMode="Enabled">
        <ContentTemplate>
          ...
          <h1>
            ...
            Date: <asp:TextBox ID="txt_Date" Width="120px" class="form-control inline" style="Color:Black; font-weight:bold" BackColor="Transparent" BorderColor="Transparent" runat="server" Text="" ReadOnly="true"></asp:TextBox>
