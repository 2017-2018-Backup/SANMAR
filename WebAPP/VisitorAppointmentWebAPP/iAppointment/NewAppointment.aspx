...
<asp:Content ID="Content2" ContentPlaceHolderID="COntent2" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" ViewStateMode="Enabled">
        <ContentTemplate>
          ...
          <h1>
            <%--Visitor--%>
            <small><b>Visitor Appointment No.</b></small>
            ...
            <b>Date:</b> <asp:TextBox ID="txt_Date" Width="120px" class="form-control inline" style="Color:black; font-weight:bold" BackColor="Transparent" BorderColor="Transparent" runat="server" Text="" ReadOnly="true"></asp:TextBox>
            <b>Time:</b> <span id="tick2"></span>
...
<!--
    ...
    */
    ...
    function show2() {
        ...
        thelement.innerHTML = "<b style='font-size:12;color:black;'>" + ctime + "</b>"
